...
### Integration Runner (LLM Required)

The integration runner uses the LLM-based matching workflow to rank resumes
against JDs and checks expectations from `data/expected_results/expectations.json`.
